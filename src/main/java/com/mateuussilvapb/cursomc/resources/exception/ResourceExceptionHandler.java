...
import com.mateuussilvapb.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		/*
		 * O trecho abaixo, mais especificamente o
		 * 'e.getBindingResult().getFieldErrors()' captura a lista de menssagens de
		 * erros geradas. A outra parte captura as informações do erro e passa para o
		 * método addError da classe ValidationError
		 */
